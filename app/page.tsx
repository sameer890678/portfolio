  ...
  return (
    <div className="bg-black text-white">
      ...
      <section className="flex flex-col items-center justify-center min-h-screen px-4">
        <h1 className="text-5xl md:text-8xl font-extrabold text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-pink-600 to-yellow-600">
          {text}
...
<section className="py-20 px-4 bg-gray-800 flex justify-center">
  <div className="max-w-2xl text-center p-8 rounded-lg text-white cursor-pointer shadow-lg about-hover bg-red-500">
