...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      {/* About Section */}
<section className="py-20 px-4 bg-gradient-to-r from-blue-800 via-black-500 to-red-500 flex justify-center">
...
<Link
  href="/Projects"
  className="px-6 py-3 rounded-full text-white font-semibold transform hover:scale-105 transition-all duration-300"
  style={{
